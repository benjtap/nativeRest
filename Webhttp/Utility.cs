...
namespace Webhttp
{
    ...
    {
        public static string GenerateAccessToken(userPost user, IConfiguration _configuration)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.AddHours(4), // AddHours(4) Token expiration time
        ...
        public static string GenerateAccessTokenFromRefreshToken(string refreshToken, IConfiguration _configuration )
        {
